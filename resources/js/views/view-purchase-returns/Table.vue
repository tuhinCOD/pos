        ...
        <table class="table table-bordered table-striped" style="min-width: 800px;">
            ...
            <tbody id="list">
                ...
                <tr v-for="item in props.returns" :key="item.id" class="text-center align-middle" style="font-size: 12px">
                    ...
                    <td style="font-size: 12px;">{{ item.purchase?.invoice_no || '-' }}</td>
                    ...
                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic mixed styles example">
                        <button v-if="auth.user?.role?.name !== 'super admin' && auth.user?.role?.name !== 'cashier' && auth.user?.role?.name !== 'warehouse staff'" type="button" class="btn btn-warning edit-btn" @click="emit('edit-return', item)" title="Edit return"><i class="bi bi-pencil-square"></i></button>
