        ...
        <table class="table table-bordered table-striped" width="576px">
            <thead>
                <tr class="text-center align-middle">
                    ...
                    <th class="col-1">Previous Qty</th>
                    <th class="col-1">Current Qty</th>
            ...
            <tbody id="list">
                ...
                <tr v-for="stock in props.stocks" :key="stock.id" class="text-center align-middle" style="font-size: 12px">
                    ...
                    <td>
                        <div v-if="stock.level" style="font-size: 14px;">
                            <span class="badge bg-info">{{ stock.level.name }}</span>
                        </div>
                        <div v-if="stock.level_specific" class="mt-1"  style="font-size: 12px;">
                            <small v-if="stock.level_specific.invoice_no" class="text-muted">
                                <i class="bi bi-receipt"></i> {{ stock.level_specific.invoice_no }}
                            </small>
                        </div>
