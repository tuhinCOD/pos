        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title fw-bold"><i class="bi bi-file-earmark-excel-fill me-2"></i>Export Selected</h5>
...
const props = defineProps({
    ...
    idsParam: { type: String, default: 'ids' },
});
...
const handleExport = async () => {
    ...
    try {
        const params = { [props.idsParam]: props.selectedIds.join(','), days: days.value };
        const response = await axios.get(`/api/${props.endpoint}/export`, {
            params,
            responseType: 'blob',
        });
        ...
        if (err.response?.data) {
            ...
            reader.onload = () => {
                try {
                    ...
                    errorMsg.value = json.message || 'Export failed';
                } catch {
                    errorMsg.value = 'Export failed';
                }
            };
